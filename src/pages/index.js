...
useEffect(()=>{
  ...
  return (
    <>
      <Head>
        <title>Portifólio Ramon.Dev</title>
        <meta name="description" content="POrtifolio de Ramon.dev" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="keywords" content="portifólio , tecnologia ,desenvolvedor, programação "/>
        <meta name="robots" content="noindex , nofollow" />
        <meta property="og:title" content="portifolio desenvolvedor web Ramon Lopes , ramon.dev"></meta>
        <meta property="og:description" content="portifolio dedicado a mostrar as habilidades em programação e desenvolvimento web"></meta>
        <meta name="author" content="Ramon Lopes"/>
